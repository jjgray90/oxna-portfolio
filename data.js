const dataArr = [
  ...
  },
  {
    title: "Punk API",
    skillTags: ["React", "API"],
    text: "Tasked with using the Punk API to fetch beers based on user input parameters. Built with React, a good lesson in asynchronous behaviour.",
    gitHub: "https://github.com/jjgray90/punk-api",
    liveSite: "https://punk-api.jjgray.me/",
    img: "assets/images/punk-api.png",
